...
- [Data types](technote.htm#dtypes)  
  - [vint](technote.htm#vint)  
  - [byte, uint16, uint32, uint64](technote.htm#byte)  
  - [Variable length data](technote.htm#varlen)  
  - [Hexadecimal values](technote.htm#hex)  
- [General archive structure](technote.htm#arcstruct)  
  - [General archive block format](technote.htm#genblock)  
  - [General extra area format](technote.htm#extarea)  
  - [General archive layout](technote.htm#arclayout)  
- [Archive blocks](technote.htm#arcblocks)  
  - [Self-extracting module (SFX)](technote.htm#sfx)  
  - [RAR 5.0 signature](technote.htm#rarsign)  
  - [Archive encryption header](technote.htm#enchead)  
  - [Main archive header](technote.htm#mainhead)    
    - [Extra record types](technote.htm#mainextra)    
    - [Locator record](technote.htm#locrecord)    
    - [Metadata record](technote.htm#metarecord)    
  - [File header and service header](technote.htm#filehead)    
    - [Extra record types](technote.htm#fileextra)    
    - [File encryption record](technote.htm#encrecord)    
    - [File hash record](technote.htm#hashrecord)    
    - [File time record](technote.htm#timerecord)    
    - [File version record](technote.htm#verrecord)    
    - [File system redirection record](technote.htm#redirrecord)    
    - [Unix owner record](technote.htm#uownrecord)    
    - [Service data record](technote.htm#servicerecord)    
  - [End of archive header](technote.htm#endarchead)  
- [Service headers](technote.htm#srvheaders)  
  - [Archive comment header](technote.htm#srvcmt)  
  - [Quick open header](technote.htm#srvqopen)  
...
| ----------------- | ---------------- | ------------------------------------------------------------ |
| Type              | vint             | 0x03                                                         |
| Flags             | vint             | 0x0001   Time is stored in Unix time_t format if this flags is set  and in Windows FILETIME format otherwise   0x0002   Modification time is present   0x0004   Creation time is present   0x0008   Last access time is present   0x0010   Unix time format with nanosecond precision |
...
RAR uses service headers based on the [file header](technote.htm#filehead) data structure to store different supplementary information.
...
Optional header storing the quick open record. Contains QO identifier in file name field. Placed after all file headers, but before the recovery record and end of archive header. It is possible to locate the quick open header with [locator record](technote.htm#locrecord) in main archive header.
